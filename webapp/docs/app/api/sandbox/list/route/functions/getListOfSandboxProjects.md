...
[webapp](../../../../../../modules.md) / [app/api/sandbox/list/route](../README.md) / getListOfSandboxProjects

# Function: getListOfSandboxProjects()

> **getListOfSandboxProjects**(): `Promise`\<`any`[]\>

Defined in: [app/api/sandbox/list/route.ts:21](https://github.com/FischkopDev/heiProb/blob/54ba7323aa531a9efde7470a7e0e509b8bffc8ae/webapp/app/api/sandbox/list/route.ts#L21)
