...
[webapp](../../../../../../modules.md) / [app/api/challenges/list/route](../README.md) / getListOfChallenges

# Function: getListOfChallenges()

> **getListOfChallenges**(): `Promise`\<`any`[]\>

Defined in: [app/api/challenges/list/route.ts:23](https://github.com/FischkopDev/heiProb/blob/54ba7323aa531a9efde7470a7e0e509b8bffc8ae/webapp/app/api/challenges/list/route.ts#L23)
