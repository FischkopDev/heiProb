...
[webapp](../../../../../../modules.md) / [app/api/challenges/add/route](../README.md) / addChallenge

# Function: addChallenge()

> **addChallenge**(`body`): `Promise`\<`number`\>

Defined in: [app/api/challenges/add/route.ts:21](https://github.com/FischkopDev/heiProb/blob/54ba7323aa531a9efde7470a7e0e509b8bffc8ae/webapp/app/api/challenges/add/route.ts#L21)
