...
[Heiprob](../../../../../../modules.md) / [app/api/users/update/route](../README.md) / updateExpert

# Function: updateExpert()

> **updateExpert**(`id`, `body`): `Promise`\<`any`\>

Defined in: [app/api/users/update/route.ts:99](https://github.com/FischkopDev/heiProb/blob/273212ca3142618532c4f1a30b727aa47a99ce60/webapp/app/api/users/update/route.ts#L99)
